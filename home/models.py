...
class Toyota(models.Model):
    ...
    #__Toyota_FIELDS__
    agungtoyota = models.TextField(max_length=255, null=True, blank=True)
    top sales = models.CharField(max_length=255, null=True, blank=True)
    best employe = models.TextField(max_length=255, null=True, blank=True)
